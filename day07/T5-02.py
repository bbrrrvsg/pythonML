...
# [*] 문자열에 대한 군집은 범주형이라서 힘들다. kmodes 모델 사용 하거나 *딥러닝* 모델 사용.
...
print( df )   #  0 : 전자자기  ,   1 : 과일 

#                        자연어_문장                    예측군집
# 0                사과 바나나 과일 식사                    1
# 1                 포도 멜론 단맛 과일                     1
# 2     삼성 스마트폰 아이폰 출시 갤럭시 전자기기               0
...
# [2] 전체 문장에서 단어 나열하여 총7개 키워드/단어 추출      ,  사과,바나나,과일,식사,포도,멜론,단맛
# [3] 첫번째 문장은 7가지 키워드에 존재하는지 검토 , 존재하면 1 , 존재하지 않은 0 
#       사과,바나나,과일,식사,포도,멜론,단맛  -->  1 , 1 , 1 , 1 , 0 , 0, 0
# [4] 두번째 문장은 7가지 키워드에 존해하는지 검토2
#       사과,바나나,과일,식사,포도,멜론,단맛  -->  0 , 0 , 1 , 0 , 1 , 1 , 1 
# 스케일링 
# [5] 1 , 1 , 1 , 1 , 0 , 0, 0  제곱의 합으로  총합을 1 으로 만든다.