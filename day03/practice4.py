...
print(lr.coef_) # 0.76          기울기(가중치)
print(lr.intercept_) # -0.38    (y절편)
print(lr.predict([[5.0]])) # 3.42 =  0.76 × 5.0 + (-0.39)
...
print(lr.predict([[4.0**2, 4.0], [6.0**2, 6.0]]))
...
# 특성을 제곱 해도 모델 자체는 선형이기 때문에 비선형 패턴까지 표현가능 